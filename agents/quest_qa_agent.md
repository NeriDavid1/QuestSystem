...
- NPC naming: verify that every learner-facing NPC mention in dialogue and quest descriptions includes a clear Hebrew name or role followed by the exact English NPC name from the registry, so the learner can find the character.
