...
- Hebrew learner language: all Hebrew instructions, explanations, translations, and dialogue must use simple, child-friendly language that a learner can understand without decoding formal or vague wording. Rewrite unclear phrases before approval; do not replace the Hebrew with Russian or another language.
- Topic introduction: before the first practice task for a new grammar topic, verify that the opening dialogue or prompt briefly explains what the forms mean and how they are used. For example, when teaching verb to be, explain that he/she/it use “is” and we/you/they use “are” before asking the learner to practise.
- Topic progression: organise practice so one sub-skill is introduced and reinforced before the next one is added. Mix previously taught sub-skills only in a later review or final quest after each component has been practised separately.
